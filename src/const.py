...
dotenv.load_dotenv(dotenv_path="/home/apollo/Code/dotcom/.venv/.env")
...
CHECK_AVAILABILITY: (
    bool  # If search for a domain, and True, will check its availability.
)
...
DOTDATA_DIR: str = "/home/apollo/Code/dotcom/.data"
